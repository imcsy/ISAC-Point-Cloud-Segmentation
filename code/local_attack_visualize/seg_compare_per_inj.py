...
MY_PER_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\sem_seg\pointnet2_sem_seg_pointguard\epoch_10_npoint_1024_bsize_16\per_attack_perfect_score.csv"
my_per_df = pd.read_csv(MY_PER_MODEL)

VAN_INJ_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\sem_seg\pointnet2_sem_seg\epoch_10_npoint_1024_bsize_16\inj_mIoU_vs_nclutter.csv"
van_inj_df = pd.read_csv(VAN_INJ_MODEL)
NOI_INJ_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\sem_seg\pointnet2_sem_seg\epoch_10_npoint_1024_bsize_16_dropout_shift\inj_mIoU_vs_nclutter.csv"
noi_inj_df = pd.read_csv(NOI_INJ_MODEL)
MY_INJ_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\sem_seg\pointnet2_sem_seg_pointguard\epoch_10_npoint_1024_bsize_16\inj_mIoU_vs_nclutter.csv"
