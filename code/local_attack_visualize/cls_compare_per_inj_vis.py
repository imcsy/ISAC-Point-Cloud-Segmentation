...
#%%
VAN_PER_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\classification\pointnet_cls_mymodelnet\epoch_10_npoint_16_bsize_64\per_attack_comparison_channel_[0, 1, 2, 3]_eps_1.0.csv"
van_per_df = pd.read_csv(VAN_PER_MODEL)
NOI_PER_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\classification\pointnet_cls_mymodelnet\epoch_10_npoint_16_bsize_64_dropout_shift\per_attack_comparison_channel_[0, 1, 2, 3]_eps_1.0.csv"
...
MY_PER_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\classification\pointnet_cls_mymodelnet_defense\epoch_10_npoint_16_bsize_32\per_attack_comparison_channel_[0, 1, 2, 3]_eps_1.0.csv"
my_per_df = pd.read_csv(MY_PER_MODEL)

VAN_INJ_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\classification\pointnet_cls_mymodelnet\epoch_10_npoint_16_bsize_64\inj_attack_comparison_npointsinj_4_cluttersizeinj_2.csv"
van_inj_df = pd.read_csv(VAN_INJ_MODEL)
NOI_INJ_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\classification\pointnet_cls_mymodelnet\epoch_10_npoint_16_bsize_64_dropout_shift\inj_attack_comparison_npointsinj_4_cluttersizeinj_2.csv"
...
MY_INJ_MODEL = r"G:\我的云端硬盘\THESIS\Pointnet_Pointnet2_pytorch-master\log\classification\pointnet_cls_mymodelnet_defense\epoch_10_npoint_16_bsize_32\inj_attack_comparison_npointsinj_4_cluttersizeinj_2.csv"
...
ax.plot(my_inj_df['cd_lower'], my_inj_df['class_acc'] * 100, 
