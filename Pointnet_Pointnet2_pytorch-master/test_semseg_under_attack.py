...
def parse_args():
    ...
    parser.add_argument('--inj_npoint', type=int, default=100, help='Number of Points Injected')
...
def main(args):
    ...
    TEST_DATASET = S3DISDataset_mix(split='test', data_root=root, num_point=NUM_POINT, sample_rate=1.0, transform=None, samples_per_frame=args.samples_per_frame, num_classes=NUM_CLASSES,
                                    ...
                                    inj_npoint=args.inj_npoint, inj_clutter_size=args.inj_clutter_size)
    ...
    with torch.no_grad():
        ...
        # for i, (points, target) in tqdm(enumerate(testDataLoader), total=len(testDataLoader), smoothing=0.9):
            ...
            # if i == 0:
            #     b = 10
            #     p = points_aug[b].cpu().numpy()  # Result: (N, 5)   (x,y,z,v,a)
            ...
            #     path = f"/content/drive/MyDrive/THESIS/code/local_visualize/data/segmentation_injection_point_cloud/inj_sample_{b}_mixloader_injnpoint_{args.inj_npoint}_injsize_{args.inj_clutter_size}.npy"
        ...
        filename = "/per_attack_perfect_score.csv"
        ...
        # log_string('eval point cloud avg Chamfer Distance: %f' % cd)
        # print("Done!")
