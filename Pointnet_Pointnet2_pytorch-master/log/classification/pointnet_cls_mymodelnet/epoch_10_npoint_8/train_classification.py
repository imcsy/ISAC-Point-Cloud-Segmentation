...
def main(args):
    ...
    ins_acc_log = np.zeros(args.epoch, dtype=float)
    class_acc_log = np.zeros(args.epoch, dtype=float)
    for epoch in range(start_epoch, args.epoch):
        ...
        with torch.no_grad():
            ...
            ins_acc_log[epoch] = instance_acc
            class_acc_log[epoch] = class_acc
    ...
    np.save(str(exp_dir) + '/logs/ins_acc_log.npy', ins_acc_log)
    np.save(str(exp_dir) + '/logs/class_acc_log.npy', class_acc_log)
