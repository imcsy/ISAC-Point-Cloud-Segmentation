"""
AdvTrain
change the loader to the mix of clean and adversarial samples
"""
...
def parse_args():
    ...
    parser.add_argument('--per_prob', type=float, default=0.3, help='Data proportion of Perturbation')
    parser.add_argument('--inject_prob', type=float, default=0.3, help='Data Proportion of Injection')
    # add parameters for injection attack
    parser.add_argument('--npoints_inj', type=int, default=2, help='Number of Points Injected')
